 ...
 * @subarr: A sub-array of an array of integers to sort.
 ...
 *
 * Description: Implements the top-down merge sort algorithm. The
 * size of the left array <= the size of the right array.
 */
void merge_sort(int *array, size_t size)
{
	int *buff;
